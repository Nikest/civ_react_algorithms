...
consonants = [
    ...consonants,
    ...['вг','вн','гд','дж','дз','зв','вз','кр','кв','лн','мн','пр','пс','ст','тс','зт','зм','зн','нз','мз','кх','дх','пх','мх','мр','бх',].flatMap((c) => Array(2).fill(c)),
...
export function generatePlanetName(seed: number) {
    const endings = ['ия','ая','оя', 'он','ол','ор','ур', 'ир', 'ин', 'ис', 'ар', 'ус', 'ель', 'ант', 'иф','аф', 'ез', 'ак', 'ул', 'ол', 'ель', 'ут', 'ат', 'ет','ухт', 'ахт', 'ехт', 'арис','урис', 'орис', 'арн','орн', 'азор', 'езор', 'изор'];
